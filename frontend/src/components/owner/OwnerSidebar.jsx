      ...
      {!collapsed && (
        <div className="p-4">
          <button
            ...
            className="w-full bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors shadow-lg"
          >
            <Plus size={20} />
